...
def main():
    ...
    target_model_path = str(PROJECT_ROOT / "src" / "CSE.h5")
    output_dir = PROJECT_ROOT / "logs" / "evaluation"
    
    # Các surrogate models
    surrogate_configs = [
        {
            "name": "surrogate_model.h5 (max_queries_2000_H5)",
            "model_path": PROJECT_ROOT / "output" / "max_queries_2000_H5" / "surrogate_model.h5",
            "scaler_path": PROJECT_ROOT / "output" / "max_queries_2000_H5" / "robust_scaler.joblib",
        },
        {
            "name": "surrogate_model.h5 (max_queries_5000_H5)",
            "model_path": PROJECT_ROOT / "output" / "max_queries_5000_H5" / "surrogate_model.h5",
            "scaler_path": PROJECT_ROOT / "output" / "max_queries_5000_H5" / "robust_scaler.joblib",
        },
        {
            "name": "surrogate_model.h5 (attack_run_10000)",
            "model_path": PROJECT_ROOT / "output" / "max_queries_10000_H5" / "surrogate_model.h5",
            "scaler_path": PROJECT_ROOT / "output" / "max_queries_10000_H5" / "robust_scaler.joblib",
        }
    ]
